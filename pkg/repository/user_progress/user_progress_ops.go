...
func NewRepository(collectionName string) UserProgressRepository {
	return &repo{
...
func (r *repo) FindOne(filter, projection bson.M) (entity.UserProgressEntity, error) {
	var profile entity.UserProgressEntity
...
func (r *repo) Find(filter, projection bson.M) ([]entity.UserProgressEntity, error) {
	var profiles []entity.UserProgressEntity
